...
import charityLogo from "../assets/logo.jpg";
...
function Header() {
  ...
  return (
    <Box>
      <Box sx={{ backgroundColor: "#7B3F3F", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem" }}>
      ...
      <Box sx={{ backgroundColor: "#D08C8C", display: "flex", alignItems: "center", padding: "1rem" }}>
        ...
        <nav style={{ display: "flex", justifyContent: "center", flexGrow: 1 }}>
          ...
          <Link to="/feedback" style={{ margin: "0 1rem", color: "black", fontWeight: "bold", textDecoration: "none" }}>Feedback</Link>
          {!isLoggedIn ? (
            <>
              <Link to="/register" style={{ margin: "0 1rem", color: "black", fontWeight: "bold", textDecoration: "none" }}>Register</Link>
              <Link to="/login" style={{ margin: "0 1rem", color: "black", fontWeight: "bold", textDecoration: "none" }}>Login</Link>
            </>
          ) : (
            <Button onClick={handleLogout} variant="contained" sx={{ backgroundColor: "#7B3F3F", color: "white", marginLeft: "1rem" }}>
              Logout
            </Button>
          )}
        </nav>
